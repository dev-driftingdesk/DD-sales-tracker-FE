 ...
 * Single source of truth for all mock user data across authentication and user systems
 */
...
export const mockUsers = [
  ...
  },
  {
    ...
    maxActiveLeads: 10,
    currentActiveLeads: 5,
    preferredDealSize: { min: 1000, max: 50000 },
    languageProficiency: { english: 'native' },
    successRateBySource: { demo: 1.0 }
  }
];
...
/**
 * Get all users
 * @returns {Array} Array of all mock users
 */
export const getAllUsers = () => {
  return [...mockUsers]; // Return a copy to prevent mutations
};

/**
 * Get users by role
 * @param {string} role - User role
 * @returns {Array} Array of users with matching role
 */
 ...
 * @returns {Array} Array of users in the team
 */
